    ...
    <div style={{ overflow: "hidden" }}>
      ...
      <section style={heroSectionStyle}>
        ...
        <div style={{ ...containerStyle, position: "relative", zIndex: 10 }}>
          ...
          >
            <h1 style={heroTitleStyle}>{t("services.title")}</h1>
            <p style={heroSubtitleStyle}>{t("services.subtitle")}</p>
          </motion.div>
        </div>
      </section>
      ...
      <section style={{ ...sectionStyle, background: colors.lightGray }}>
        <div style={containerStyle}>
          ...
          >
            ...
            <p style={sectionSubtitleStyle}>From concept to completion</p>
          </motion.div>
