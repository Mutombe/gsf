...
const Projects = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      fullDescription:
        "Full banking facility shopfitting including laminated teller counters, bullet-resistant glass screens, and aluminium-framed partitions. Work comprised suspended ceilings with recessed lighting, vinyl plank flooring, and custom-fabricated stainless steel queue management barriers. All aluminium work powder-coated in corporate colors.",
      icon: Building2,
      stats: {
        area: "800m²",
        duration: "8 weeks",
    ...
    },
    {
      ...
      beforeImage: "/placeh.png",
      afterImage:
        "/FirstCapitalBorrowdale-20251118T121756Z-1-001/FirstCapitalBorrowdale_.png",
      gallery: [
        "/FirstCapitalBorrowdale-20251118T121756Z-1-001/FirstCapitalBorrowdale_(1).png",
        "/FirstCapitalBorrowdale-20251118T121756Z-1-001/FirstCapitalBorrowdale_(2).png",
        "/FirstCapitalBorrowdale-20251118T121756Z-1-001/FirstCapitalBorrowdale.png",
        "/FirstCapitalBorrowdale-20251118T121756Z-1-001/WhatsAppImage2025-11-18at11.58.55(2).jpeg",
        "/FirstCapitalBorrowdale-20251118T121756Z-1-001/WhatsAppImage2025-11-18at11.58.55(3).jpeg",
      ],
      features: [
        "ACP wall cladding",
    ...
    },
    {
      ...
      fullDescription:
        "Contemporary bank branch featuring curtain wall glazing system, powder-coated aluminium shopfront, and interior glass partitions with aluminium frames. Shopfitting included laminated service counters, suspended ceilings with LED downlights, porcelain floor tiles, and custom-fabricated aluminium signage.",
      icon: Building2,
      stats: {
        area: "900m²",
        duration: "9 weeks",
      ...
      gallery: [
        "/EcobankBorrowdale/1.png",
        "/EcobankBorrowdale/2.jpeg",
        "/EcobankBorrowdale/3.jpeg",
        "/EcobankBorrowdale/4.jpeg",
        "/EcobankBorrowdale/5.jpeg",
      ],
      features: [
    ...
    },
    {
      ...
      date: "2024",
      description:
        "Complete banking facility with aluminium shopfront and interiors",
      fullDescription:
        "Full-service bank fitout including aluminium shopfront glazing, teller counter fabrication with laminate cladding, and frameless glass office partitions. Project encompassed suspended ceilings, porcelain tiles, custom aluminium signage, and integrated security systems. All metalwork in corporate-specified powder coat finishes.",
      icon: Building2,
      stats: {
        area: "950m²",
        duration: "9 weeks",
    ...
    },
    {
      ...
      date: "2025",
      description:
        "Fast food restaurant with stainless steel kitchen and service counters",
      fullDescription:
        "Complete QSR fitout featuring stainless steel service counters, commercial kitchen installation, and branded wall cladding. Shopfitting included suspended ceilings with extract ventilation, non-slip floor tiles, aluminium-framed menu boards, and outdoor seating with powder-coated aluminium furniture.",
      icon: Coffee,
      stats: {
        area: "400m²",
        duration: "6 weeks",
      ...
      gallery: [
        "/kfcgreenfields/2.jpeg",
        "/kfcgreenfields/3.jpeg",
        "/kfcgreenfields/4.jpeg",
      ],
      features: [
    ...
    },
    {
      ...
      fullDescription:
        "Fast food restaurant shopfitting with laminated service counters, stainless steel kitchen equipment installation, and branded interior finishes. Work included suspended ceilings with integrated lighting, anti-slip flooring, aluminium signage fabrication, and custom-made outdoor seating structures.",
      icon: Coffee,
      stats: {
        area: "380m²",
        duration: "5 weeks",
      ...
      gallery: [
        "/hungryliongreenfields/2.jpg",
        "/hungryliongreenfields/3.jpg",
        "/hungryliongreenfields/4.jpg",
        "/hungryliongreenfields/5.jpg",
        "/hungryliongreenfields/6.jpg",
        "//hungryliongreenfields/7.jpg",
      ],
      features: [
    ...
    },
    {
      ...
      fullDescription:
        "Full-service restaurant featuring custom-fabricated bar counter with granite top, stainless steel commercial kitchen, and timber-look laminate dining furniture. Installation included acoustic suspended ceilings, porcelain floor tiles, aluminium-framed glass doors, and bespoke lighting fixtures.",
      icon: Coffee,
      stats: {
        area: "500m²",
        duration: "8 weeks",
      ...
      gallery: [
        ...
        "/greenfieldssmokehouse/4.jpg",
        "/greenfieldssmokehouse/5.jpeg",
        "/greenfieldssmokehouse/6.jpeg",
      ],
      features: [
    ...
    },
    {
      ...
      fullDescription:
        "Premium restaurant fitout with bespoke timber and aluminium joinery, granite-topped service stations, and stainless steel kitchen installations. Project included feature suspended ceilings, imported floor tiles, frameless glass wine displays, and custom-designed aluminium and timber furniture pieces.",
      icon: Coffee,
      stats: {
        area: "650m²",
        duration: "10 weeks",
      ...
      gallery: [
        "/smokehousesamlevy/2.jpg",
        "/smokehousesamlevy/3.jpg",
        "/smokehousesamlevy/4.jpg",
        "/smokehousesamlevy/5.jpg",
        "/smokehousesamlevy/6.jpg",
      ],
      features: [
    ...
    },
    {
      ...
      fullDescription:
        "Modern café shopfitting featuring laminated display counters with glass sneeze guards, refrigerated cake display units, and custom seating furniture. Installation included suspended ceilings, vinyl flooring, aluminium-framed entrance doors, and feature lighting over service areas.",
      icon: Coffee,
      stats: {
        area: "280m²",
        duration: "5 weeks",
      ...
      gallery: [
        "/greenfieldscafenush/2.jpg",
        "/greenfieldscafenush/3.jpg",
        "/greenfieldscafenush/4.jpg",
        "/greenfieldscafenush/5.jpg",
      ],
      features: [
    ...
    //},
    {
      ...
      fullDescription:
        "Corporate office fitout featuring aluminium-framed glass partitions, laminated workstations, and suspended ceiling systems. Installation comprised vinyl plank flooring, custom reception counter with company branding, meeting room furniture, and integrated electrical and data cabling systems.",
      icon: Building2,
      stats: {
        area: "700m²",
        duration: "8 weeks",
    ...
    },
    {
      ...
      fullDescription:
        "Bank branch shopfitting with reinforced teller counters, bullet-proof glass screens, and aluminium partitioning systems. Project scope included suspended ceilings, porcelain floor tiles, secure vault area construction, ATM booth installation, and corporate signage fabrication with LED illumination.",
      icon: Building2,
      stats: {
        area: "820m²",
        duration: "9 weeks",
  ...
  const handleDownloadBrochure = async (project) => {
    try {
      ...
      const infoText = `${project.location} • ${
        project.date
                ...
                style={{
                  ...
                  background:
                    activeFilter === filter
                      ...
                      : colors.lightGray,
                  color:
                    activeFilter === filter ? colors.white : colors.darkGray,
                  boxShadow:
                    activeFilter === filter
                      ? `0 4px 15px ${colors.chiliRed}40`
                      : "none",
                  transform:
                    activeFilter === filter ? "scale(1.05)" : "scale(1)",
          ...
          >
            ...
            >
              ...
              <div
                ...
                onClick={() => setLightboxImage(selectedProject.afterImage)}
              >
                <div
                  style={{
                    position: "absolute",
                ...
                >
                  ...
                  >
                    <ZoomIn size={18} style={{ color: colors.chiliRed }} />
                          ...
                          >
                            {[
                              ...
                              <button
                                key={item.platform}
                                onClick={() =>
                                  handleShare(item.platform, selectedProject)
                                }
                                style={{
                                  display: "flex",
                                  alignItems: "center",
                    ...
                    <div style={{ marginBottom: isMobile ? "24px" : "32px" }}>
                      ...
                      >
                        {selectedProject.gallery.map((image, idx) => (
                          <div
                            key={idx}
                            onClick={() => setLightboxImage(image)} // ADD THIS LINE
                            style={{
                              position: "relative",
      ...
      <AnimatePresence>
        {lightboxImage && (
          ...
          >
            ...
            >
              <X size={isMobile ? 22 : 26} style={{ color: colors.darkGray }} />
            </button>
