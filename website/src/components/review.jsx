...
const Testimonials = () => {
  ...
  const testimonials = [
    ...
    },
    {
      ...
      rating: 5,
      text: 'Transformed our retail space completely. The custom fixtures and displays are exactly what we needed. Professional service from start to finish.',
      source: 'website',
      date: '1 month ago',
    ...
    },
    {
      ...
      rating: 5,
      text: 'Innovative design solutions that really elevated our retail presence. The team listened to our needs and delivered beyond expectations.',
      source: 'facebook',
      date: '1 month ago',
