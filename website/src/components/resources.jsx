...
const Resources = () => {
  ...
  const resources = [
    ...
    },
    {
      ...
      description: "Aluminium market anticipated to surpass $165 billion by 2022. Metals including aluminium preferred for shelves due to cost-efficiency and durability. Asia Pacific expected to dominate.",
      excerpt: "Aluminium-based shopfitting materials are gaining preference due to their lightweight properties, durability, and design flexibility.",
      image: "https://images.unsplash.com/photo-1565008576549-57569a49371d?w=800",
      date: "2025",
      tags: ["Aluminium", "Customization", "Market Share"],
    ...
    },
    {
      ...
      description: "Analysis of aluminium-based shopfitting materials driven by demand for lightweight, durable solutions. Covers steel, glass, plastic, and specialized materials across retail sectors.",
      ...
      date: "2025",
      tags: ["Materials Analysis", "Aluminium", "Forecast"],
    ...
    },
    {
      ...
      description: "Comparative analysis of aluminium and steel in shopfitting, covering strength, durability, corrosion resistance, and aesthetic appeal. Aluminium preferred for outdoor applications.",
      ...
      date: "2024",
      tags: ["Materials Comparison", "Aluminium vs Steel", "Technical"],
    ...
    },
    {
      ...
      description: "UK supplier specializing in standard and bespoke aluminium profiles for shopfitting since 2005. Highlights flexibility of design and low maintenance properties.",
      excerpt: "Custom aluminium extrusions offer unlimited design possibilities for creating unique shopfitting solutions tailored to brand identity.",
      image: "https://images.unsplash.com/photo-1590846406792-0adc7f938f1d?w=800",
      date: "2024",
      tags: ["Aluminium Profiles", "UK Market", "Bespoke"],
    ...
    },
    {
      ...
      description: "Australian supplier offering aluminium and PVC extrusions for shopfitting, including slatwall T-extrusions, corner extrusions, and U-channel solutions for retail displays.",
      excerpt: "Versatile aluminium extrusion systems provide the foundation for flexible, modular retail display solutions.",
              ...
              <div className="flex items-center justify-center gap-4">
                ...
                <div className="text-left">
                  ...
                  <div className="text-sm text-gray-600">
                    Aluminium Shopfitting Federation
                  </div>
                </div>
              </div>
            </div>
