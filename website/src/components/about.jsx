...
import { Award, Target, Eye, Shield, Users, Zap, TrendingUp } from 'lucide-react';
...
const About = () => {
  ...
  const heroSectionStyle = {
    ...
    display: 'flex',
    alignItems: 'center',
    background: `linear-gradient(135deg, rgba(26, 26, 26, 0.95) 0%, rgba(45, 45, 45, 0.9) 50%, rgba(42, 42, 42, 0.95) 100%)`,
    color: colors.white,
    overflow: 'hidden',
  };
    ...
    <div style={{ overflow: 'hidden' }}>
      ...
      <section style={heroSectionStyle}>
        ...
        <div style={{ 
          position: 'absolute', 
          inset: 0,
          backgroundImage: 'url("https://images.unsplash.com/photo-1497366216548-37526070297c?auto=format&fit=crop&q=80")', // Replace with your actual image
      ...
      <section style={{ ...sectionStyle, background: colors.white, position: 'relative' }}>
        {/* Decorative Elements */}
        <div style={{
          position: 'absolute',
          top: '10%',
        ...
        <div style={containerStyle}>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '64px', alignItems: 'center', position: 'relative', zIndex: 1 }}>
            <motion.div
            ...
            >
              ...
              <div style={{ 
                ...
                <div style={{ 
                  ...
                  <Award size={200} style={{ color: 'rgba(255, 255, 255, 0.2)' }} />
                </div>
              ...
              >
                <div style={{
                  width: '48px',
                  height: '48px',
                  background: `linear-gradient(135deg, ${colors.mustardYellow}, ${colors.amber})`,
                  borderRadius: '12px',
                  display: 'flex',
                  alignItems: 'center',
                  justifyContent: 'center',
                ...
                <div style={{ fontSize: '1.25rem', fontWeight: '700', color: colors.darkGray, marginTop: '4px' }}>
                  Best in Class
                </div>
              </motion.div>
            </motion.div>
            ...
            {values.map((value, index) => {
              ...
              return (
                <motion.div
                  ...
                  style={{ 
                    ...cardStyle,
                    gridColumn: value.size === 'large' && window.innerWidth > 768 ? 'span 2' : 'span 1',
                    padding: '32px',
                    display: 'flex',
                    flexDirection: 'column',
